...
export declare class DiagramComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DiagramComponent, "gojs-diagram", never, { "initDiagram": { "alias": "initDiagram"; "required": false; }; "nodeDataArray": { "alias": "nodeDataArray"; "required": false; }; "linkDataArray": { "alias": "linkDataArray"; "required": false; }; "modelData": { "alias": "modelData"; "required": false; }; "divClassName": { "alias": "divClassName"; "required": false; }; "skipsDiagramUpdate": { "alias": "skipsDiagramUpdate"; "required": false; }; }, { "modelChange": "modelChange"; }, never, never, true, never>;
}
