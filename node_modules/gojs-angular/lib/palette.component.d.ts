...
export declare class PaletteComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PaletteComponent, "gojs-palette", never, { "initPalette": { "alias": "initPalette"; "required": false; }; "nodeDataArray": { "alias": "nodeDataArray"; "required": false; }; "linkDataArray": { "alias": "linkDataArray"; "required": false; }; "modelData": { "alias": "modelData"; "required": false; }; "divClassName": { "alias": "divClassName"; "required": false; }; }, { "modelChange": "modelChange"; }, never, never, true, never>;
}
